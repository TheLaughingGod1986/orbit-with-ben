#!/usr/bin/env python3
"""Apply yellow_white_v02 covers in desktop Studio via CDP.

new_page per listing. Wait until the video id is in the URL before upload.
...
OUT = Path("/tmp/orbit_thumbs_v02_apply_result.json")
SHOTS = Path("/tmp/orbit_thumbs_v02_apply")

EU = ROOT / "02_Video-Projects/006_Could-Life-Exist-Under-The-Ice-Of-Europa/10_Shorts/08_Thumbs/yellow_white_v02"
NS = ROOT / "02_Video-Projects/007_What-Happens-To-Your-Body-Near-A-Neutron-Star/10_Shorts/08_Thumbs/yellow_white_v02"
LS = ROOT / "02_Video-Projects/005_The-Last-Star-In-The-Universe/10_Shorts/08_Thumbs/yellow_white_v02"
