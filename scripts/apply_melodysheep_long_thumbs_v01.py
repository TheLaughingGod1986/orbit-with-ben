#!/usr/bin/env python3
"""Apply MelodySheep-inspired 16:9 long thumbs in desktop Studio via CDP.
...
OUT = Path("/tmp/orbit_long_thumbs_v01_apply_result.json")
SHOTS = Path("/tmp/orbit_long_thumbs_v01_apply")

EU = ROOT / "02_Video-Projects/006_Could-Life-Exist-Under-The-Ice-Of-Europa/08_Thumbnail/melodysheep_v01"
NS = ROOT / "02_Video-Projects/007_What-Happens-To-Your-Body-Near-A-Neutron-Star/08_Thumbnail/melodysheep_v01"

LONGS = [
    {"id": "NbW5G1BpPY0", "cover": EU / "cover_A_NbW5G1BpPY0.jpg"},
    {"id": "Yk1tLh23rko", "cover": NS / "cover_A_Yk1tLh23rko.jpg"},
]
...
def main() -> int:
    ...
    report = {
        "task": "melodysheep_long_thumbs_v01",
