...
1. **Pre-build vidIQ audit (blocking)** before script lock / VO / AI Studio Veo gen → `00_Brand/Channel-Setup/PRE_BUILD_VIDIQ_AUDIT_TEMPLATE.md`
...
6. **CG = AI Studio Veo UI / Ultra** (`04_Audio/tools/orbit_aistudio_veo_ui.py`) · **VO = ElevenLabs** Ben Orbit Narrator only — never EL Image & Video for CG; API key is fallback only
...
def main() -> None:
    ...
    out = {
        "env": {
            ...
            "ORBIT_CG_ENGINE": "aistudio-veo-ui",
