#!/usr/bin/env python3
"""Neutron Star Part 01 v04 — Omni Flash via Gemini API first, Flow Playwright backup."""
...
REPORT = HERE / "parts/part-01_omni_gen_report_cursor_v04.json"
...
def main() -> None:
    ...
    for plate in PLATES["plates"]:
        ...
        try:
            meta = omni.generate_omni_clip(client, plate["prompt"], dest)
