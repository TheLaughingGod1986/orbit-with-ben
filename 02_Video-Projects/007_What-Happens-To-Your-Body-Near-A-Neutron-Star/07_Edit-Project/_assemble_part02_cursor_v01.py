#!/usr/bin/env python3
"""Assemble Neutron Star Part 02 v01: VO-literal, continuous score, xfade joins."""
...
PLATES = json.loads((HERE / "parts/part-02_omni_plates_cursor_v01.json").read_text())
RAW = EP / "04_Generated-Clips/01_Raw/part-02"
VO = EP / "02_Voiceover/parts/neutron_star_part-02_vo_v01.wav"
if not VO.exists():
    VO = EP / "02_Voiceover/parts/neutron_star_part-02_vo_v01.mp3"
MUSIC = EP / "05_Music/neutron_star_part02_score_bed_v01.mp3"
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part02_cursor_v01"
QC = EP / "_qc_p02_cursor_v01"
XFADE = 0.40
...
def main() -> None:
    ...
    open15 = OUT_DIR / "neutron_star_part-02_cursor_open15_v01.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "veryfast", "-crf", "18",
