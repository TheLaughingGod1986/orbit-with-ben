#!/usr/bin/env python3
"""Assemble Neutron Star Part 08 v01: VO-literal, polish mix, QuickTime yuv420p."""
...
PLATES = json.loads((HERE / "parts/part-08_omni_plates_cursor_v01.json").read_text())
RAW = EP / "04_Generated-Clips/01_Raw/part-08"
VO = EP / "02_Voiceover/parts/neutron_star_part-08_vo_v01.wav"
if not VO.exists():
    VO = EP / "02_Voiceover/parts/neutron_star_part-08_vo_v01.mp3"
MUSIC = EP / "05_Music/neutron_star_part08_score_bed_v01.mp3"
OUT_DIR = HERE / "parts"
...
def main() -> None:
    ...
    open15 = OUT_DIR / "neutron_star_part-08_cursor_open15_v01.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "medium", "-crf", "16", "-pix_fmt", "yuv420p",
