        ...
        try:
            ...
            if plate.get("orbit"):
                prompt += (
                    ...
                    " MOTION LOCK: hold station or drift in a straight line, nose along travel."
                    " Do NOT spin, corkscrew, tumble, barrel-roll, or orbit around the remnant."
                    " Camera does not circle the pair."
                )
