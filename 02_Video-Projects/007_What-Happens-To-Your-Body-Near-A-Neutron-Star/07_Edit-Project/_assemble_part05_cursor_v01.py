#!/usr/bin/env python3
"""Assemble Neutron Star Part 05 v01: VO-literal, continuous score, xfade joins."""
...
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part05_cursor_v01"
QC = EP / "_qc_p05_cursor_v01"
XFADE = 0.40
...
def main() -> None:
    ...
    master_dur = vo_dur
    rough = OUT_DIR / "neutron_star_part-05_cursor_rough_v01.mp4"
    graph = (
    ...
    open15 = OUT_DIR / "neutron_star_part-05_cursor_open15_v01.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "veryfast", "-crf", "18",
