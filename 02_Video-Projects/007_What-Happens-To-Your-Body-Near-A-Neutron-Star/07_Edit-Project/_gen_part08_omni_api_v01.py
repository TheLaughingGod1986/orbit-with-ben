#!/usr/bin/env python3
"""Neutron Star Part 08 v01 — Omni Flash via Gemini API first, Flow Playwright backup."""
...
PLATES_JSON = HERE / "parts/part-08_omni_plates_cursor_v01.json"
PLATES = json.loads(PLATES_JSON.read_text())
OUT = EP / "04_Generated-Clips/01_Raw/part-08"
REPORT = HERE / "parts/part-08_omni_gen_report_cursor_v01.json"
