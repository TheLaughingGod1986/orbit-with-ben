#!/usr/bin/env python3
"""Assemble Neutron Star Part 03 v01: VO-literal, continuous score, xfade joins."""
...
PLATES = json.loads((HERE / "parts/part-03_omni_plates_cursor_v01.json").read_text())
RAW = EP / "04_Generated-Clips/01_Raw/part-03"
VO = EP / "02_Voiceover/parts/neutron_star_part-03_vo_v01.wav"
if not VO.exists():
    VO = EP / "02_Voiceover/parts/neutron_star_part-03_vo_v01.mp3"
MUSIC = EP / "05_Music/neutron_star_part03_score_bed_v01.mp3"
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part03_cursor_v01"
QC = EP / "_qc_p03_cursor_v01"
# 10×8s − 9×0.40s = 76.4s, 0.62s short of 77.04s VO. 0.32s still soft-joins and covers.
XFADE = 0.32
...
def main() -> None:
    ...
    master_dur = vo_dur
    rough = OUT_DIR / "neutron_star_part-03_cursor_rough_v01.mp4"
    graph = (
    ...
    open15 = OUT_DIR / "neutron_star_part-03_cursor_open15_v01.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "veryfast", "-crf", "18",
