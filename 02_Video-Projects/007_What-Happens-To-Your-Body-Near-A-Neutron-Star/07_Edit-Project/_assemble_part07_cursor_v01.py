#!/usr/bin/env python3
"""Assemble Neutron Star Part 07 v01: VO-literal, polish mix, QuickTime yuv420p."""
...
PLATES = json.loads((HERE / "parts/part-07_omni_plates_cursor_v01.json").read_text())
...
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part07_cursor_v03"
QC = EP / "_qc_p07_cursor_v03"
XFADE = 0.40
FADE_IN = 0.18
FADE_OUT = 0.40
...
def main() -> None:
    ...
    rough = OUT_DIR / "neutron_star_part-07_cursor_rough_v03.mp4"
    graph = (
    ...
    open15 = OUT_DIR / "neutron_star_part-07_cursor_open15_v03.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "medium", "-crf", "16", "-pix_fmt", "yuv420p",
