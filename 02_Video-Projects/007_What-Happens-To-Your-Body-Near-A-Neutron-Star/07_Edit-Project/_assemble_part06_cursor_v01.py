#!/usr/bin/env python3
"""Assemble Neutron Star Part 06 v01: VO-literal, Part 05 polish mix, xfade joins."""
...
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part06_cursor_v01"
QC = EP / "_qc_p06_cursor_v01"
XFADE = 0.40
FADE_IN = 0.18
FADE_OUT = 0.40
...
def main() -> None:
    ...
    rough = OUT_DIR / "neutron_star_part-06_cursor_rough_v01.mp4"
    graph = (
    ...
    open15 = OUT_DIR / "neutron_star_part-06_cursor_open15_v01.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "medium", "-crf", "16",
