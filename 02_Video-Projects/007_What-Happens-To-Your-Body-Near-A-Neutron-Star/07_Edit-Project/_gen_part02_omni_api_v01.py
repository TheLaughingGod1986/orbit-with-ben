#!/usr/bin/env python3
"""Neutron Star Part 02 v01 — Omni Flash via Gemini API first, Flow Playwright backup."""
...
PLATES_JSON = HERE / "parts/part-02_omni_plates_cursor_v01.json"
PLATES = json.loads(PLATES_JSON.read_text())
OUT = EP / "04_Generated-Clips/01_Raw/part-02"
REPORT = HERE / "parts/part-02_omni_gen_report_cursor_v01.json"
