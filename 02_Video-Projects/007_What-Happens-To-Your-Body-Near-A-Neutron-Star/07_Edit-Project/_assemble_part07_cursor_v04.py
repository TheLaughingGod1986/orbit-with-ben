#!/usr/bin/env python3
"""Assemble Neutron Star Part 07 v04: remnant-first 8s picture recut. VO+music stay."""
...
PLATES = json.loads((HERE / "parts/part-07_omni_plates_cursor_v04.json").read_text())
RAW = EP / "04_Generated-Clips/01_Raw/part-07"
VO = EP / "02_Voiceover/parts/neutron_star_part-07_vo_v01.wav"
if not VO.exists():
    VO = EP / "02_Voiceover/parts/neutron_star_part-07_vo_v01.mp3"
MUSIC = EP / "05_Music/neutron_star_part07_score_bed_v01.mp3"
OUT_DIR = HERE / "parts"
WORK = HERE / "parts/_work_part07_cursor_v04"
QC = EP / "_qc_p07_cursor_v04"
XFADE = 0.50
FADE_IN = 0.18
FADE_OUT = 0.40
# Picture-first remnant before VO so the P06→P07 join is not a VO punch-in.
VO_DELAY = 2.00
...
def main() -> None:
    ...
    rough = OUT_DIR / "neutron_star_part-07_cursor_rough_v04.mp4"
    graph = (
    ...
    open15 = OUT_DIR / "neutron_star_part-07_cursor_open15_v04.mp4"
    run([
        "ffmpeg", "-y", "-hide_banner", "-loglevel", "error",
        "-i", str(rough), "-t", "15",
        "-c:v", "libx264", "-preset", "medium", "-crf", "16", "-pix_fmt", "yuv420p",
