...
ORBIT: two reaction beats only — after the open, along the rings; near the end, small against bare Saturn. Not in the open.
CHAPTER CARDS: soft starfield, about 1.5s breath, music continues. Card titles are the act titles in this script.
END: after the last spoken line, hold the last real picture at least 15–20 seconds. Music fades over about 10 seconds. Picture fades to black over the last 2 seconds. No baked subscribe. No affiliate. No /go/. Hand-off to live title: What Happens When the Last Star Dies?
SCIENCE LOCK: water ice + dust; main rings ~10 m thick in places; ring mass ~0.4 Mimas (Iess et al. 2019); magnetic ring rain detected from Earth with Keck (O'Donoghue et al. 2019) → ~300 Myr at that rate; Cassini Grand Finale 22 dives measured equatorial inflow from the D ring (Waite et al. 2018) → under ~100 Myr when added; honest lifetime range ~100–300 Myr; age still debated (most read low mass as young; Hyodo et al. 2024 argues rings could be old); Roche-limit moon breakup labelled as an idea. One Saturn. If a probe appears it is Cassini only — not credited with magnetic ring rain.
...
Ice. Not rock. Water ice, the same bright mineral as a comet, dirty in places and clean in others. Most of the mass sits in chunks you could hold, or in boulders the size of a house. Rocky dust rides with the ice and slowly stains it cream to tan.
...
[VISUAL MUST: ON SCREEN: Drop through ten metres. Camera falls through the thin sheet into open space; Saturn’s banded atmosphere sits far below the inner edge. No Orbit.]
...
We did not need a spacecraft inside that rain to know it was there. Astronomers on Earth, using the Keck telescope, watched the glow of that water in Saturn’s upper air and measured how fast the ice was leaving. At that magnetic rain rate alone, the sheet would last about three hundred million years.
...
More mass. Cleaner ice. A harder white, because the dust had not had time to dirty it. Saturn would still have been the ringed one — only more so. A broader blade. A brighter one. The planet underneath was already the planet. The rings look like a late arrival.

Why “new”, when Saturn itself is about four and a half billion years old?

Because a heavy, ancient ring would still be heavy, unless most of its mass has already gone in. Most researchers read Cassini’s low mass as young — a few hundred million years at most. A few argue the rings could still be old, and hide their age another way. The debate is open. The honest line is narrower than a slogan: the rings you see are ice, they are already leaving, and their birthday is not settled.
...
Saturn is still there. Pale gold bands. A fast day, a little over ten hours, written as soft stripes in a deep atmosphere. The curve of the planet runs clean. The shadow the rings used to cast on the clouds is gone. The famous thing was never the body. It was the ice in orbit around the body.
...
```
SOURCES (for description — not spoken):
- Iess et al. 2019 — Cassini radio-science ring mass (~0.4 Mimas / low mass).
- O’Donoghue et al. 2019 — magnetic ring rain detected from Earth with Keck; ~300 Myr lifetime at that rate alone.
- Waite et al. 2018 (and NASA 2018 Grand Finale release) — Cassini’s 22 proximal dives; equatorial inflow from the D ring into Saturn; under ~100 Myr when that leak is included.
- Hyodo et al. 2024 — counter-argument that Saturn’s rings could be old despite low mass.
- NASA / JPL-Caltech — Cassini Grand Finale (2017): 22 gap orbits; end of mission 15 Sep 2017.
- NASA Cassini — ring composition: water ice with trace rocky dust; main-ring thickness of order ~10 m in places.
- Roche-limit moon disruption — one proposed young-ring origin, not settled.
- Saturn rotation — equatorial day a little over 10 hours (banded atmosphere).
Framework: HOOK → QUESTION → ESCALATION → DISCOVERY → PAYOFF → BIGGER QUESTION
Runtime target: 8–9 min spoken (~150 wpm).
Picture-first: first 3s rings only. No Orbit. No title. No logo.
Orbit: exactly two [ORBIT ACTS].
One Saturn. Probe = Cassini only (equatorial inflow — not magnetic ring rain).
End hand-off speaks the live title: What Happens When the Last Star Dies?
No /go/. No product. No fearbait. No goodbye.
```
