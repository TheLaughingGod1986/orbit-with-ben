#!/usr/bin/env python3
"""Assemble Moon Leaving Part 03 rough v04 — variety plates minted with remaining Flow credits.
...
WORK = PROJ / "07_Edit-Project/parts/_work_p03_v04"
OUT = PROJ / "07_Edit-Project/parts/moon_leaving_part-03_rough_v04.mp4"
META = PROJ / "07_Edit-Project/parts/moon_leaving_part-03_rough_v04_meta.json"
PLATE_MAP = PROJ / "07_Edit-Project/parts/part-03_plates_v04.json"
...
def main() -> None:
        ...
        json.dumps(
            {
                ...
                "picture_first": True,
                "orbit_in_open": False,
                "from": "moon_leaving_part-03_rough_v03.mp4",
                "variety_plates": [
                    "p03_18",
                    "p03_19",
                    "p03_20",
    ...
    if not UAT.exists():
        ...
        return
    dest = UAT / "moon_leaving_part-03_rough_v04.mp4"
    shutil.copy2(OUT, dest)
    (UAT / "moon_leaving_part-03_STATUS.txt").write_text(
        "Part 03 (Why It Drifts) — ROUGH v04 ready for watch\n"
        f"File: {dest.name}\n"
        f"Duration: {probe(OUT):.1f}s\n"
        "v04 spends the remaining Flow credits (Veo 3.1 Fast @ 10 credits/gen) on the queued variety plates:\n"
