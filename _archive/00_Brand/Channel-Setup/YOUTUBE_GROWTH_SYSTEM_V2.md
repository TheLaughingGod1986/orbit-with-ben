...
3. Links via YouTube **Related video pill** → that week’s Thursday long only (**no new Short pins**; pin not required when Related is set; see `orbit-shorts-related-video.mdc`)  
