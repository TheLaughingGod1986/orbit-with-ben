# Rejected — not Orbit identity lock

These plates look like a *near-miss* Flow/Agent redesign, **not** the channel mascot.

Hard-fail traits present:

- Large white / pale chest disc
- Two-sphere head + body split (neck gap)
- Headphone / ear-ring side discs
- Detached floating arms (when present)
